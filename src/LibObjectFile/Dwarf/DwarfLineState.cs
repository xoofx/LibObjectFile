...
/// <summary>
/// Internal struct used to track line state via a struct, created via <see cref="DwarfLine.ToState"/>
/// </summary>
internal struct DwarfLineState
{
    // -----------------------
    // DWARF 2
    // -----------------------
    ...
    internal void Delta(in DwarfLineState against, 
