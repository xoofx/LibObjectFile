...
namespace LibObjectFile
{
    public static class ObjectFileExtensions
    {
        ...
        public static void Add<TParent, TChild>(this List<TChild> list, TParent parent, TChild element) where TChild : ObjectFileNode<TParent> where TParent : ObjectFileNode
        {
        ...
        public static void AddSorted<TParent, TChild>(this List<TChild> list, TParent parent, TChild element, bool requiresUnique = false) where TChild : ObjectFileNode<TParent>, IComparable<TChild> where TParent : ObjectFileNode
        {
            if (element == null) throw new ArgumentNullException(nameof(element));
            if (element.Parent != null)
            {
        ...
        public static void InsertAt<TParent, TChild>(this List<TChild> list, TParent parent, int index, TChild element) where TChild : ObjectFileNode<TParent> where TParent : ObjectFileNode
        {
        ...
        public static void Remove<TParent, TChild>(this List<TChild> list, TParent parent, TChild child) where TChild : ObjectFileNode<TParent> where TParent : ObjectFileNode
        {
        ...
        public static TChild RemoveAt<TParent, TChild>(this List<TChild> list, TParent parent, int index) where TChild : ObjectFileNode<TParent> where TParent : ObjectFileNode
        {
            if (index < 0 || index > list.Count) throw new ArgumentOutOfRangeException(nameof(index), $"Invalid index {index}, Must be >= 0 && <= {list.Count}");
